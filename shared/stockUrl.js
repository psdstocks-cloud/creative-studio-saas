...
const ALLOWED_STOCK_HOSTNAMES = new Set([
  'shutterstock.com',
...
const isHostnameSupported = (hostname) => {
...
export const parseStockUrl = (input) => {
...
export const isHostnameAllowed = (hostname) => isHostnameSupported(hostname);
