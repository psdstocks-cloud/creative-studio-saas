      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <CodeBlock>
              <span className="text-green-500">GET</span> https://nehtw.com/api/me?apikey=
              <span className="text-red-400">{'{your_api_key}'}</span>
            </CodeBlock>
            <h3 className="font-semibold mt-6 mb-2">
              {t('method2')}{' '}
              <span className="text-xs bg-green-200 dark:bg-green-900 text-green-800 dark:text-green-300 font-bold py-1 px-2 rounded-full ms-2">
                {t('recommended')}
              </span>
            </h3>
            <CodeBlock>
        ...
        <section>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
            ...
            <p>{t('step1Desc')}</p>
            <CodeBlock>
              <span className="text-green-500">GET</span> https://nehtw.com/api/stockinfo/
            ...
            <p>{t('step2Desc')}</p>
            <CodeBlock>
              <span className="text-green-500">GET</span> https://nehtw.com/api/stockorder/
              <span className="text-purple-400">{'{site}'}</span>/
              <span className="text-purple-400">{'{id}'}</span>
            </CodeBlock>
            ...
            <p>{t('step3Desc')}</p>
            <CodeBlock>
              <span className="text-green-500">GET</span> https://nehtw.com/api/order/
              <span className="text-purple-400">{'{task_id}'}</span>/status
            </CodeBlock>
            <h3 className="text-xl font-bold mt-4">{t('step4')}</h3>
            <p>{t('step4Desc')}</p>
            <CodeBlock>
              <span className="text-green-500">GET</span> https://nehtw.com/api/v2/order/
              <span className="text-purple-400">{'{task_id}'}</span>/download
            </CodeBlock>
          </div>
        </section>
