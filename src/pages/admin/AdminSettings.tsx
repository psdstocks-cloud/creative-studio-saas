      ...
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">
            Inspect runtime configuration surfaced by the BFF, including polling thresholds, rate
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border border-slate-800/60 bg-slate-950/40 p-4 text-sm text-slate-200">
                ...
                <p>
                  Refresh threshold: {Math.round(data.session.refreshThresholdMs / 1000 / 60)}{' '}
                  minutes
                </p>
              </div>
            </div>
