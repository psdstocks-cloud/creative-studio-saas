...
const renderStatusBadge = (status?: string) => {
  ...
  switch (status) {
    ...
    case 'failed':
      return (
        <span className={`${base} border-rose-500/40 bg-rose-500/10 text-rose-300`}>Failed</span>
      );
    default:
      return (
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/60 p-6">
        ...
        <p className="mt-1 text-sm text-slate-400">
          Events derived from the audit log that reference <code className="font-mono">/aig/*</code>{' '}
          endpoints.
        </p>
