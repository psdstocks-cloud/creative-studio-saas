...
export const translations = {
  en: {
    ...
    reDownloadFree: "You have downloaded this file before. Re-download is free.",
    ...
    batchTotalCost: "Total cost for {count} files:",
    // AI Generator
    ...
    filesManagerSubtitle: "View and manage all your downloaded stock files.",
    searchPlaceholder: "Search by file ID, site, or URL...",
  ...
  ar: {
    ...
    batchOrderError: "فشل طلب {count} ملفات. تم استرداد النقاط الخاصة بها.",
    reDownloadFree: "لقد قمت بتنزيل هذا الملف من قبل. إعادة التنزيل مجانية.",
    ...
    batchUrlLabel: "أدخل ما يصل إلى 5 روابط، رابط واحد في كل سطر",
    batchUrlPlaceholder: "https://...\nhttps://...",
    error: "خطأ",
    batchSummaryTitle: "ملخص الطلب",
    batchTotalCost: "التكلفة الإجمالية لـ {count} ملفات:",
    // AI Generator
    ...
    filesManagerSubtitle: "عرض وإدارة جميع ملفات الستوك التي قمت بتنزيلها.",
    searchPlaceholder: "ابحث عن طريق معرف الملف أو الموقع أو الرابط...",
