-- ============================================
-- STOCK SOURCES TABLE
-- Stores available stock media sources with pricing
-- ============================================
...
CREATE POLICY "Anyone can view active stock sources"
  ON public.stock_sources
  FOR SELECT
  USING (true); -- Public read access for all authenticated users
